...
<style>
	body{
		...
		background: linear-gradient(90deg, rgba(8,2,92,1) 0%, rgba(128,128,255,1) 49%, rgba(8,2,92,1) 100%);
  	...
  	<div class="container">
  		...
  		<div id="login-center" class="row justify-content-center align-self-center w-100">
  			<div class="d-flex justify-content-center align-items-center w-100">
  				...
  				<h2 class="text-gradient-primary"><b>Tuneify</b></h2>
  				</span>
  			</div>
