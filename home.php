        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box bg-black border border-primary">
              <span class="info-box-icon bg-secondary elevation-1"><i class="fas fa-th-list text-gradient-primary"></i></span>
           ...
           <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box bg-black border border-primary">
              <span class="info-box-icon bg-secondary elevation-1"><i class="fas fa-music text-gradient-primary"></i></span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box bg-black border border-primary">
              <span class="info-box-icon bg-secondary elevation-1"><i class="fas fa-list text-gradient-primary"></i></span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box bg-black border border-primary">
              <span class="info-box-icon bg-secondary elevation-1"><i class="fas fa-users text-gradient-primary"></i></span>
