...
<div class="col-lg-12">
	<div class="row">
		<div class="col-md-4">
			...
			<center>
			<button class="btn btn-primary mt-2" type="button" id="manage_plist">Manage List</button>
			</center>
			<?php endif; ?>
			</div>
			<div>
		...
		<div class="col-md-8">
			...
			<tbody>
				<?php 
				$i = 0;
					$items = $conn->query("SELECT p.*,m.title,m.stars,m.upath FROM playlist_items p inner join uploads m on m.id = p.music_id where p.playlist_id =$id ");
